...
namespace Garage_3_MVCEF.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public VehicleTypesController(Garage_3_MVCEFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,VehicleTypeName,ParkingSpot")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VehicleTypeName,ParkingSpot")] VehicleType vehicleType)
        {
