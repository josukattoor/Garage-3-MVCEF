...
namespace Garage_3_MVCEF.Controllers
{
    public class ParkingSpotsController : Controller
    {
        ...
        public ParkingSpotsController(Garage_3_MVCEFContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ParkingSpotNumber")] ParkingSpot parkingSpot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ParkingSpotNumber")] ParkingSpot parkingSpot)
        {
